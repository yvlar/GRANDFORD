# Carte d'embarquement — Sprint 13 : Journal des changements (FR-13)
...
### v1.1 — Journal des changements (FR-13) [recommandé pour Sprint 13]
...
Sprint 13 (Journal des changements — FR-13) en suivant .claude/prompts/prompt-executer-sprint.md — Phase A.

Branche : claude/sprint13-journal (à créer depuis dev).
