...
export const fr = {
  ...
  // Liste d'épicerie (Sprint 25) — listes PARTAGÉES du foyer : les deux membres ajoutent,
  // retirent et cochent. R7 : un libellé d'article n'est pas un motif d'absence.
  epicerie: {
    ...
    confirmerSuppressionListe: "Confirmer la suppression",
    annuler: "Annuler",
    elementPlaceholder: "Ajouter un article…",
    ajouterElement: "Ajouter",
    retirerElement: "Retirer",
    cocher: "Cocher",
    decocher: "Décocher",
    // Badge du compte restant à acheter (icône + texte, NFR-12).
    restant: (n: number) => `${n} à acheter`,
    toutCoche: "Tout est acheté",
    cochePar: (nom: string) => `coché par ${nom}`,
    vide: "Aucune liste d'épicerie pour l'instant.",
    listeVide: "Liste vide — ajoutez un article.",
    parMoi: "Moi",
    nouvelleListeToast: "Nouvelle liste d'épicerie.",
    erreurCreationListe: "La création de la liste a échoué. Réessayez.",
    erreurSuppressionListe: "La suppression de la liste a échoué. Réessayez.",
