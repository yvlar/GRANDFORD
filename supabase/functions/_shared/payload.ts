// Copie partagée de lib/notifications/payload.ts pour les Edge Functions Deno.
// WHY dossier _shared : Deno/Supabase bundlent uniquement les fichiers sous
// supabase/functions/ — l'import relatif hors de ce dossier est refusé au
// déploiement MCP et fragile avec le CLI. La source de vérité reste
// lib/notifications/payload.ts (app Next.js + tests) ; cette copie sert
// exclusivement à l'exécution Edge. Toute évolution du type ou du format
// doit toucher LES DEUX fichiers.
//
